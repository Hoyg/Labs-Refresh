...
12. Click **Tasks** hyperlink in the **Dev** environment box. The tasks are the activities your deployment process performs. In this example, a task was created to deploy to **Azure App service**.
